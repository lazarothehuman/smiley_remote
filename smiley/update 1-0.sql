...
CREATE TABLE `consulta_procedimento` (
  ...
  `procedimentos_id` bigint(20) NOT NULL,
  KEY `FKq5wyl1ynxbfeoki5o2livqvsx` (`procedimentos_id`),
  KEY `FKsgndwi6v0g10vhqmwr92pcd56` (`Consulta_id`),
  CONSTRAINT `FKq5wyl1ynxbfeoki5o2livqvsx` FOREIGN KEY (`procedimentos_id`) REFERENCES `procedimento` (`id`),
  CONSTRAINT `FKsgndwi6v0g10vhqmwr92pcd56` FOREIGN KEY (`Consulta_id`) REFERENCES `consulta` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `transaccao` VALUES (1,'',101,'/application/forms/Add-Client.fxml'),(2,'',102,'/application/forms/Add-User.fxml'),(3,'',103,'/application/forms/Add-Medico.fxml'),(4,'',104,'/application/forms/Add-Procedimento.fxml'),(5,'',105,'/application/forms/Add-Consulta.fxml'),(6,'',201,'/application/forms/Modify-Client.fxml'),(7,'',202,'/application/forms/Modify-User.fxml'),(8,'',203,'/application/forms/Modify-Medico.fxml'),(9,'',206,'/application/forms/Modify-Profile.fxml'),(10,'',304,'/application/views/View-Procedimentos.fxml');
...
INSERT INTO `transaccao_profile` VALUES (1,1),(2,1),(2,2),(3,1),(3,2),(4,1),(4,2),(5,1),(5,2),(6,1),(6,2),(7,1),(7,2),(8,1),(8,2),(9,1),(9,2),(1,2),(10,1),(10,2);
...
INSERT INTO `user` VALUES (1,'','lazaro','Yd3+4Zn96g+hvwkNQnLEqA==:6UkKqE/IBbF9THkSu6mFMg==','lazaro',2,NULL),(13,'','diana','zaTBagsy1tbECk14XUhrpQ==:J4nr1EKntBjQuQakhJhvvQ==','diana',3,NULL);
...
-- Dump completed on 2019-02-19  7:07:56
